...
public abstract class ColorPropertyEditor
{
	...
	implements OptionListener
	{
		...
		public ButtonPopup(UndoStack aUndoStack, IRWProperty<Color> aProperty)
		{
			...
			itsButtonPopup = new ButtonPopupComponent(itsChooserPanel, itsButton);
		...
		@Override
		protected void propertyToUi(Color aValue)
		{
			itsButton.setBackground(aValue);
			itsChooserPanel.setSelectedColor(aValue);
		}

		@Override
		protected void uiToProperty()
		{
			getProperty().set(itsChooserPanel.getSelectedColor());
		}
