...
/**
 * A thumbnail cache that always responds immediately to requests.
 * A separate thread creates the thumbnails in the background.
 * Listeners can regigister themselves to be notified when new thumbnails have been created.
 * @author gpothier
 */
